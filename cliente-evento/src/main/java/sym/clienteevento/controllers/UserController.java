...
public class UserController {
    ...
    public String users(Model model) {
        final String uri = "http://localhost:8080/getUsers";
    ...
    public String create(@RequestParam("name") String name, @RequestParam("password") String password, @RequestParam("mail") String mail, @RequestParam("role") String role){
        ...
        final String email_uri ="http://localhost:4040/factura/sendAccountNotification?username=" + name + "&username_email=" + mail;
